...
def tta_inference(inp, model, num_classes=6, scales=[1.0], flip=False):
    b, _, h, w = inp.size()
    ...
    for scale in scales:
        ...
        pred = model_inference(model, inp, flip)
...
def load_model(model_path):
    ...
    model = get_net(model_name, 3, num_class, img_size)
...
def test_original():
    test_path = '/home/ydy/Vaihingen/img_test'
    model_path = '/home/ydy/attentionunet_files/unet_att_3/pth_unet_att/187.pth'
    color_txt = '/home/ydy/Vaihingen/color_table_isprs.txt'
    save_path = '../swinunet_result'
...
if __name__ == '__main__':
    test_path = '/home/Vaihingen/train_img/test'
    model_path = '/home/model_name_files/model_name/pth_unet/187.pth'
    color_txt = '/home/Vaihingen/color_table_isprs.txt'
    save_path = '..model_name_result'
    color_table = parse_color_table(color_txt)
    if os.path.exists(save_path) is True:
        shutil.rmtree(save_path)
        os.mkdir(save_path)
